...
import { expandLawAliasQueries, ignoredStandaloneLawQueries, isLawLikeSearchQuery } from "./lawSearchTerms";

const topicKeywords = {
  labor: ["노동", "근로", "직원", "사업장", "노무", "인사", "취업규칙", "포괄임금", "고용", "알바", "아르바이트", "해고", "권고사직", "퇴사", "채용", "연차"],
  ...
  safety: ["안전", "산업안전", "안전보건", "위험성평가", "보호구역", "통학버스", "시설기준", "산재", "사고", "보호구", "중대재해", "작업중지", "안전교육"],
  privacy: [
    "개인정보",
    "민감정보",
    "회원정보",
